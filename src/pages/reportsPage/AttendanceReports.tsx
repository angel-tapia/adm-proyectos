  ...
  return (
    <div className="scrollable-content">
      ...
      <p className="description">
        Resumen mensual de asistencias, ausencias, tardanzas y horas extras
      </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="employee-data">
                    <div className="data">
                      <span className="data-value">{employee.asistencias}</span>
                    ...
                    <div className="data">
                      <span className="data-value">{employee.horasExtras}</span>
